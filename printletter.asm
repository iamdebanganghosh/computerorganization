...
; Display the message "Enter the character: "
...
msg_input  DB 'Enter the character: $'  ; Input prompt message
msg_output DB 0Dh, 0Ah, 'The output is: $'  ; Output message with newline (CRLF)